...
export default function JobCard({ job, isLoading = false, onError }: JobCardProps) {
  // Removed bookmark state and handler as bookmark feature is removed
  ...
  // Removed bookmark handler as bookmark feature is removed
          ...
          <div className="absolute inset-0 bg-red-500/10 backdrop-blur-sm border border-red-500/20  flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300">
            <div className="text-center p-4">
              ...
              <button
                ...
                className="text-xs text-red-400 hover:text-red-300 hover:underline mt-2 hover:neon-border font-medium transition-colors"
              >
                Retry
              </button>
            </div>
